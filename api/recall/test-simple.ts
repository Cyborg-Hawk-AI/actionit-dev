...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    console.log('[Recall Simple Test] Testing Recall.ai configuration');
    ...
    console.log('[Recall Simple Test] API key found, testing basic functionality...');
    ...
    console.log('[Recall Simple Test] Configuration test successful');
    
    return res.json(testData);
    
  } catch (error) {
    console.error('[Recall Simple Test] Configuration test failed:', error);
