...
import { Mail, Calendar, Bot, Shield, Zap, Users, ArrowRight, Check, Clock, Sparkles } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="group hover:scale-[1.02] transition-all duration-300 interactive-element">
